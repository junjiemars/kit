...
create table Person(name varchar(64), age int, gender varchar(64));
create table Frequents(name varchar(64), pizzeria varchar(64));
create table Eats(name varchar(64), pizza varchar(64));
create table Serves(pizzeria varchar(64), pizza varchar(64), price decimal);
